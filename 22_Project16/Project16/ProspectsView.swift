        ...
        NavigationView {
            List {
                ForEach(filteredProspects) { prospect in
                    ...
                    //CHALLENGE 3
                    .confirmationDialog("Sort Prospects by...", isPresented: $isShowingDialog) {
                        Button("Sort by name") {
                            prospects.sortedByNamePeople()
                        }
                        Button("Sort by date added") {
                            prospects.sortedByDatePeople()
                        }
                    }
                    .swipeActions {
                        if prospect.isConnected {
            ...
            .sheet(isPresented: $isShowingScanner) {
                CodeScannerView(codeTypes: [.qr], simulatedData: "Dean Thompson\ndeanthompson@gmail.com", completion: handleScan)
            }
